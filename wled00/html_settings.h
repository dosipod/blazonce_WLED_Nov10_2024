...
<button type="submit">Save</button><hr><h2>LED setup</h2>LED type: <select 
name="LTsel" onchange="sTY()"><option value="22" selected="selected">
...
min="1" max="1500" oninput="UI()" required></div></div><br><div id="ledwarning" 
