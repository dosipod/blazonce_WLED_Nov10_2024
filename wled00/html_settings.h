...
LED &amp; HW setup</h2>LED strips <button type="button" id="+" 
onclick="addLEDs(1)" style="display:none">+</button><button type="button" 
id="-" onclick="addLEDs(-1)" style="display:none">-</button><br><div id="mLC">
<div name="iST">1: <select name="LTsel" onchange="UI(!0)"><option value="22">
WS281x</option><option value="30">SK6812</option><option value="50">WS2801
</option><option value="51">APA102</option><option value="52">LPD8806</option>
<option value="53">P9813</option><option value="54">TM1814</option></select>
 CO: <select name="CO"><option value="0">GRB</option><option value="1">RGB
</option><option value="2">BRG</option><option value="3">RBG</option><option 
value="4">BGR</option><option value="5">GBR</option></select> RGBW: <input 
type="checkbox" name="EW" onchange="UI()" id="rgbw"><br>pin:<input name="LP" 
type="number" min="0" max="40" required onchange="UI()"><div name="iLK" 
style="display:inline">clk:<input name="LK" type="number" min="0" max="40" 
onchange="UI()"></div>count:<input name="LC" type="number" min="1" 
oninput="UI()" required><br>reversed (rotate 180°): <input type="checkbox" 
name="RV" onchange="UI()"></div></div><hr>Relay pin: <input type="number" 
min="-1" max="40" name="RL" onchange="UI()"> Inverse? <input type="checkbox" 
name="RM"><br>Button pin: <input type="number" min="-1" max="40" name="BT" 
onchange="UI()"><br>IR pin: <input type="number" min="-1" max="40" name="IR" 
onchange="UI()"><br>AUX pin: <input type="number" min="-1" max="40" name="AX" 
onchange="UI()"><hr><div id="ledwarning" style="color:orange;display:none">
