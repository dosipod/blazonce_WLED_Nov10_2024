...
const char PAGE_settingsCss[] PROGMEM = R"=====(<style>body{font-family:Verdana,sans-serif;text-align:center;background:#222;color:#fff;line-height:200%;margin:0}hr{border-color:#666}button{background:#333;color:#fff;font-family:Verdana,sans-serif;border:.3ch solid #333;border-radius:24px;display:inline-block;font-size:20px;margin:12px 8px 8px;padding:8px 12px;min-width:48px}.helpB{text-align:left;position:absolute;width:60px}input{background:#333;color:#fff;font-family:Verdana,sans-serif;border:.5ch solid #333}input[type=number]{width:4em;font-size:medium;margin:2px}select{margin:2px;font-size:medium}input[type=checkbox]{-ms-transform:scale(2);-moz-transform:scale(2);-webkit-transform:scale(2);-o-transform:scale(2);transform:scale(2)}select{background:#333;color:#fff;font-family:Verdana,sans-serif;border:.5ch solid #333}td{padding:2px}.d5{width:4.5em!important}</style>)=====";
...
var d=document,laprev=55;function H(){window.open("https://github.com/Aircoookie/WLED/wiki/Settings#led-settings")}function B(){window.open("/settings","_self")}function S(){GetV(),setABL()}function enABL(){var e=d.getElementById("able").checked;d.Sf.LA.value=e?laprev:0,d.getElementById("abl").style.display=e?"inline":"none",d.getElementById("psu2").style.display=e?"inline":"none",d.Sf.LA.value>0&&setABL()}function enLA(){var e=d.Sf.LAsel.value;d.Sf.LA.value=e,d.getElementById("LAdis").style.display=50==e?"inline":"none",UI()}function setABL(){switch(d.getElementById("able").checked=!0,d.Sf.LAsel.value=50,parseInt(d.Sf.LA.value)){case 0:d.getElementById("able").checked=!1,enABL();break;case 30:d.Sf.LAsel.value=30;break;case 35:d.Sf.LAsel.value=35;break;case 55:d.Sf.LAsel.value=55;break;case 255:d.Sf.LAsel.value=255;break;default:d.getElementById("LAdis").style.display="inline"}d.getElementById("maxLED").innerText=d.LCmax,UI()}function UI(e=!1){d.getElementById("ampwarning").style.display=d.Sf.MA.value>7200?"inline":"none",255==d.Sf.LA.value?laprev=12:d.Sf.LA.value>0&&(laprev=d.Sf.LA.value);for(var t=d.getElementsByTagName("select"),a=!1,l=0;l<t.length;l++)if("LTsel"==t[l].name.substring(0,5)){n=t[l].name.substring(5),e&&(d.getElementsByName("EW"+n)[0].checked=30==parseInt(t[l].value)||54==parseInt(t[l].value)),a|=d.getElementsByName("EW"+n)[0].checked;var i=d.getElementsByName("LK"+n)[0],r=d.getElementsByName("iLK");n=""==n?0:parseInt(n,10),t[l].value>49&&54!=t[l].value?(r[n].style="display:inline;",i.required=!0):(r[n].style="display:none;",i.required=!1,i.value="")}var s=d.querySelectorAll(".wc");for(l=0;l<s.length;l++)s[l].style.display=a?"inline":"none";var p,u=d.getElementsByTagName("input"),m=0,c=0;for(l=0;l<u.length;l++){var o=u[l].name.substring(0,2);if("LC"!=o){if("LP"==o){var v=d.getElementsByName("LC"+u[l].name.substring(2))[0];d.LDmax&&3==u[l].value?v.max=d.LDmax:v.max=d.LCmax}if(("LP"==o||"LK"==o||"RL"==o||"BT"==o||"IR"==o||"AX"==o)&&""!=u[l].value&&"-1"!=u[l].value){if(d.um_p&&d.um_p.some(e=>e==parseInt(u[l].value,10))){alert("Usermod pin clash!"),u[l].value="",u[l].focus();continue}for(j=0;j<u.length;j++)if(l!=j){var y=u[j].name.substring(0,2);if(("LP"==y||"LK"==y||"RL"==y||"BT"==y||"IR"==y||"AX"==y)&&""!=u[j].value&&u[l].value==u[j].value){alert("Pin clash!"),u[l].value="",u[l].focus();break}}}}else m+=p=parseInt(u[l].value,10),c=p>c?p:c}d.getElementById("ledwarning").style.display=m>1e3?"inline":"none",d.getElementById("ledwarning2").style.display=c>800?"inline":"none";var E=Math.ceil((100+m*laprev)/500)/2;E=E>5?Math.ceil(E):E;t="";var L=30==d.Sf.LAsel.value,f=255==d.Sf.LAsel.value;E<1.02&&!L&&!f?t="ESP 5V pin with 1A USB supply":(t+=L?"12V ":f?"WS2815 12V ":"5V ",t+=E,t+="A supply connected to LEDs");var g=Math.ceil((100+d.Sf.LC.value*laprev)/1500)/2,h="(for most effects, ~";h+=g=g>5?Math.ceil(g):g,h+="A is enough)<br>",d.getElementById("psu").innerHTML=t,d.getElementById("psu2").innerHTML=f?"":h}function addLEDs(e){if(e>1)return d.maxST=e,void(d.getElementById("+").style="display:inline;");var t=d.getElementsByName("iST"),n=t.length;if(!(1==e&&n>=d.maxST||-1==e&&n<=1)){var a=d.getElementById("mLC");if(1==e){var l,i=d.createElement("div");i.setAttribute("name","iST"),i.appendChild(d.createTextNode(n+1+": ")),(l=d.createElement("select")).setAttribute("name","LTsel"+n),l.onchange=function(){UI(!0)},(t=d.createElement("option")).text="WS281x",t.value="22",l.add(t),(t=d.createElement("option")).text="SK6812",t.value="30",l.add(t),(t=d.createElement("option")).text="WS2801",t.value="50",l.add(t),(t=d.createElement("option")).text="APA102",t.value="51",l.add(t),(t=d.createElement("option")).text="LPD8806",t.value="52",l.add(t),(t=d.createElement("option")).text="P9813",t.value="53",l.add(t),(t=d.createElement("option")).text="TM1814",t.value="54",l.add(t),i.appendChild(l),i.appendChild(d.createTextNode(" CO: ")),(l=d.createElement("select")).setAttribute("name","CO"+n),(t=d.createElement("option")).text="GRB",t.value="0",l.add(t),(t=d.createElement("option")).text="RGB",t.value="1",l.add(t),(t=d.createElement("option")).text="BRG",t.value="2",l.add(t),(t=d.createElement("option")).text="RBG",t.value="3",l.add(t),(t=d.createElement("option")).text="BGR",t.value="4",l.add(t),(t=d.createElement("option")).text="GBR",t.value="5",l.add(t),i.appendChild(l),i.appendChild(d.createTextNode(" RGBW: ")),(l=d.createElement("input")).type="checkbox",l.setAttribute("name","EW"+n),i.appendChild(l),i.appendChild(d.createElement("br")),i.appendChild(d.createTextNode("pin:"));var r=d.createElement("input");r.type="number",r.value="",r.name="LP"+n,r.min=0,r.max=40,r.required=!0,r.onchange=function(){UI()},i.appendChild(r);var s=d.createElement("div");s.setAttribute("name","iLK"),s.appendChild(d.createTextNode(" clk:")),(r=d.createElement("input")).type="number",r.value="",r.name="LK"+n,r.min=0,r.max=40,r.onchange=function(){UI()},d.getElementsByName("LTsel")[0].value>49&&(r.required=!0),s.appendChild(r),i.appendChild(s),i.appendChild(d.createTextNode(" count:")),(r=d.createElement("input")).type="number",r.value="0",r.name="LC"+n,r.min=0,r.max=d.LCmax,r.required=!0,r.oninput=function(){UI()},i.appendChild(r),i.appendChild(d.createElement("br")),a.appendChild(i),i.appendChild(d.createTextNode(" reversed (rotate 180°): ")),(l=d.createElement("input")).type="checkbox",l.setAttribute("name","RV"+n),i.appendChild(l),i.appendChild(d.createElement("br")),a.appendChild(i)}-1==e&&(t[--n].remove(),--n);var p=d.getElementById("+"),u=d.getElementById("-");n<d.maxST-1?p.style="display:inline":p.style="display:none",u.style=n>0?"display:inline":"display:none",UI()}}function GetV() {var d=document;
...
<button type="submit">Save</button><hr><h2>LED &amp; HW setup</h2>LED strips 
<button type="button" id="+" onclick="addLEDs(1)" style="display:none">+
</button><button type="button" id="-" onclick="addLEDs(-1)" 
style="display:none">-</button><br><div id="mLC"><div name="iST">1: <select 
name="LTsel" onchange="UI(!0)"><option value="22">WS281x</option><option 
value="30">SK6812</option><option value="50">WS2801</option><option value="51">
APA102</option><option value="52">LPD8806</option><option value="53">P9813
</option><option value="54">TM1814</option></select> CO: <select name="CO">
<option value="0">GRB</option><option value="1">RGB</option><option value="2">
BRG</option><option value="3">RBG</option><option value="4">BGR</option><option 
value="5">GBR</option></select> RGBW: <input type="checkbox" name="EW" 
onchange="UI()" id="rgbw"><br>pin:<input name="LP" type="number" min="0" 
max="40" required onchange="UI()"><div name="iLK" style="display:inline">clk:
<input name="LK" type="number" min="0" max="40" onchange="UI()"></div>count:
<input name="LC" type="number" min="1" oninput="UI()" required><br>
reversed (rotate 180°): <input type="checkbox" name="RV" onchange="UI()"></div>
</div><hr>Relay pin: <input type="number" min="-1" max="40" name="RL" 
onchange="UI()"> Inverse? <input type="checkbox" name="RM"><br>Button pin: 
...
<span class="wc">Auto-calculate white channel from RGB:<br><select name="AW">
<option value="0">None</option><option value="1">Brighter</option><option 
value="2">Accurate</option><option value="3">Dual</option><option value="4">
Legacy</option></select><br></span><h3>Defaults</h3>
...
type="number" name="TD" maxlength="5" size="2"> ms<br>
Enable Palette transitions: <input type="checkbox" name="PF"><h3>Timed light
</h3>Default Duration: <input name="TL" type="number" min="1" max="255" 
required> min<br>Default Target brightness: <input name="TB" type="number" 
min="0" max="255" required><br>Mode: <select name="TW"><option value="0">
Wait and set</option><option value="1">Fade</option><option value="2">Fade Color
</option><option value="3">Sunrise</option></select><h3>Advanced</h3>
...
</select><br>Skip first LED: <input type="checkbox" name="SL"><hr><button 
