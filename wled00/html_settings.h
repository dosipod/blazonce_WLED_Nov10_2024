...
var d=document,laprev=55;function H(){window.open("https://github.com/Aircoookie/WLED/wiki/Settings#led-settings")}function B(){window.open("/settings","_self")}function S(){GetV(),setABL(),addLEDs(4),sTY(0)}function enABL(){var e=d.getElementById("able").checked;d.Sf.LA.value=e?laprev:0,d.getElementById("abl").style.display=e?"inline":"none",d.getElementById("psu2").style.display=e?"inline":"none",d.Sf.LA.value>0&&setABL()}function enLA(){var e=d.Sf.LAsel.value;d.Sf.LA.value=e,d.getElementById("LAdis").style.display=50==e?"inline":"none",UI()}function setABL(){switch(d.getElementById("able").checked=!0,d.Sf.LAsel.value=50,parseInt(d.Sf.LA.value)){case 0:d.getElementById("able").checked=!1,enABL();break;case 30:d.Sf.LAsel.value=30;break;case 35:d.Sf.LAsel.value=35;break;case 55:d.Sf.LAsel.value=55;break;case 255:d.Sf.LAsel.value=255;break;default:d.getElementById("LAdis").style.display="inline"}UI()}function UI(){var e=d.querySelectorAll(".wc"),t=e.length;for(i=0;i<t;i++)e[i].style.display=d.getElementById("rgbw").checked?"inline":"none";d.getElementById("ampwarning").style.display=d.Sf.MA.value>7200?"inline":"none",255==d.Sf.LA.value?laprev=12:d.Sf.LA.value>0&&(laprev=d.Sf.LA.value);var n=d.getElementsByTagName("input"),a=0;for(i=0;i<n.length;i++){var l=n[i].name.substring(0,2);if("LC"==l&&(a+=parseInt(n[i].value)),"LP"==l){var r=d.getElementsByName("LC"+n[i].name.substring(2))[0];3==n[i].value?r.max=500:r.max=1500}if(("LP"==l||"LK"==l||"RL"==l||"BT"==l||"IR"==l||"AX"==l)&&""!=n[i].value&&"-1"!=n[i].value)for(j=0;j<n.length;j++)if(i!=j){var s=n[j].name.substring(0,2);"LP"!=s&&"LK"!=s&&"RL"!=s&&"BT"!=s&&"IR"!=s&&"AX"!=s||""!=n[j].value&&n[i].value==n[j].value&&(alert("Pin clash!"),n[j].value="")}}d.getElementById("ledwarning").style.display=a>1e3?"inline":"none";var u=Math.ceil((100+a*laprev)/500)/2;u=u>5?Math.ceil(u):u;var p="",m=30==d.Sf.LAsel.value,o=255==d.Sf.LAsel.value;u<1.02&&!m&&!o?p="ESP 5V pin with 1A USB supply":(p+=m?"12V ":o?"WS2815 12V ":"5V ",p+=u,p+="A supply connected to LEDs");var c=Math.ceil((100+d.Sf.LC.value*laprev)/1500)/2,v="(for most effects, ~";v+=c=c>5?Math.ceil(c):c,v+="A is enough)<br>",d.getElementById("psu").innerHTML=p,d.getElementById("psu2").innerHTML=o?"":v}function sTY(e){console.log(e);var t=d.getElementsByTagName("select");for(i=0;i<t.length;i++)if("LTsel"==t[i].name.substring(0,5)&&t[i].name.substring(5)==e){t=t[i];break}var n=d.getElementsByName("iLK");d.getElementsByName("EW"+(e>0?e:""))[0].checked=30==parseInt(t.value)||54==parseInt(t.value);var a=d.getElementsByName("LK"+(e>0?e:""))[0];t.value>49&&54!=t.value?(n[e].style="display:inline;",a.required=!0):(n[e].style="display:none;",a.required=!1,a.value=""),UI()}function addLEDs(e){if(e>1)return d.maxST=e,void(d.getElementById("+").style="display:inline;");var t=d.getElementsByName("iST"),n=t.length;if(!(1==e&&n>=d.maxST||-1==e&&n<=1)){var a=d.getElementById("mLC");if(1==e){var l,i=d.createElement("div");i.setAttribute("name","iST"),i.appendChild(d.createTextNode(n+1+": ")),(l=d.createElement("select")).setAttribute("name","LTsel"+n),l.onchange=function(){sTY(n)},(t=d.createElement("option")).text="WS281x",t.value="22",l.add(t),(t=d.createElement("option")).text="SK6812",t.value="30",l.add(t),(t=d.createElement("option")).text="WS2801",t.value="50",l.add(t),(t=d.createElement("option")).text="APA102",t.value="51",l.add(t),(t=d.createElement("option")).text="LPD8806",t.value="52",l.add(t),(t=d.createElement("option")).text="P9813",t.value="53",l.add(t),(t=d.createElement("option")).text="TM1814",t.value="54",l.add(t),i.appendChild(l),i.appendChild(d.createTextNode(" CO: ")),(l=d.createElement("select")).setAttribute("name","CO"+n),(t=d.createElement("option")).text="GRB",t.value="0",l.add(t),(t=d.createElement("option")).text="RGB",t.value="1",l.add(t),(t=d.createElement("option")).text="BRG",t.value="2",l.add(t),(t=d.createElement("option")).text="RBG",t.value="3",l.add(t),(t=d.createElement("option")).text="BGR",t.value="4",l.add(t),(t=d.createElement("option")).text="GBR",t.value="5",l.add(t),i.appendChild(l),i.appendChild(d.createTextNode(" RGBW: ")),(l=d.createElement("input")).type="checkbox",l.setAttribute("name","EW"+n),i.appendChild(l),i.appendChild(d.createElement("br")),i.appendChild(d.createTextNode("pin:"));var r=d.createElement("input");r.type="number",r.value="",r.name="LP"+n,r.min=0,r.max=40,r.required=!0,r.onchange=function(){UI()},i.appendChild(r);var s=d.createElement("div");s.setAttribute("name","iLK"),s.appendChild(d.createTextNode(" clk:")),(r=d.createElement("input")).type="number",r.value="",r.name="LK"+n,r.min=0,r.max=40,r.onchange=function(){UI()},d.getElementsByName("LTsel")[0].value>49&&(r.required=!0),s.appendChild(r),i.appendChild(s),i.appendChild(d.createTextNode(" count:")),(r=d.createElement("input")).type="number",r.value="",r.name="LC"+n,r.min=0,r.max=1e3,r.required=!0,r.oninput=function(){UI()},i.appendChild(r),i.appendChild(d.createElement("br")),a.appendChild(i),sTY(n)}-1==e&&(t[--n].remove(),--n);var u=d.getElementById("+"),p=d.getElementById("-");n<d.maxST-1?u.style="display:inline":u.style="display:none",p.style=n>0?"display:inline":"display:none"}}function GetV() {var d=document;
...
name="LTsel" onchange="sTY(0)"><option value="22">WS281x</option><option 
