...
<button type="submit">Save</button><hr><h2>LED setup</h2><div id="mLC">LED pin 
<input name="LP" type="number" min="0" max="20"> &amp; count: <input name="LC" 
type="number" min="1" max="1500" oninput="UI()" required></div><br><div 
